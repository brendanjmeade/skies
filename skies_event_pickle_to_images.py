...
# List pickle files in target folder
run_folder = "./runs/2022_11_11_20_21_51/"
event_file_names = glob.glob(run_folder + "*.pickle")
n_event_files = len(event_file_names)
event_file_names.sort()
pickle_file_indices = range(n_event_files)
event_file_index = 0

# # Plot event time series
# moment_magnitude = list()
# event_index = list()
# for i in range(10000 - 2):
#     print(i)
#     event = pickle.load(open(event_file_names[i], "rb"))
#     moment_magnitude.append(event.moment_magnitude)
#     event_index.append(i)

# plt.figure()
# plt.plot(moment_magnitude, "rx")
...
# for event_file_index in range(n_event_files):
# for event_file_index in range(7198, 10000):
